...
test('anonymous journal preserves the typed content and fails closed before a private write', async ({ page }) => {
  ...
  await expect(page.getByText('请先登录后保存。点击“登录并保存草稿”可在此浏览器暂存草稿。')).toBeVisible()
